...
# スピードのスケールファクター（1/10にするための調整値）
speed_scale_factor = 0.1 #new
...
def turn_left(power1, power2):
    left_front.set_power(power1)
    left_rear.set_power(power1)
    right_front.set_power(power2)
    right_rear.set_power(power2)

def turn_right(power1, power2):
    left_front.set_power(power1)
    left_rear.set_power(power2)
    right_front.set_power(power1)
    right_rear.set_power(power2)
...
def speed_val():
    ...
    return (left_rear_speed() + right_rear_speed()) / 2.0 * speed_scale_factor # new

# スピードの設定 new
def set_motor_power(motor, power):
    if motor == 1:
        left_front.set_power(power * speed_scale_factor)
    elif motor == 2:
        right_front.set_power(power * speed_scale_factor)
    elif motor == 3:
        left_rear.set_power(power * speed_scale_factor)
    elif motor == 4:
        right_rear.set_power(power * speed_scale_factor)
